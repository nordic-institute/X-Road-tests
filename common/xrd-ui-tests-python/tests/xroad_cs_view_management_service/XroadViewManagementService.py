...
from tests.xroad_cs_view_management_service.view_management_service import view_management_service


class XroadViewManagementService(unittest.TestCase):
    """
    ...
    """
    def __init__(self, methodName='test_view_management_service'):
    ...
    def test_view_management_service(self):
        ...
        server_name = main.config.get('ss1.management_name')
