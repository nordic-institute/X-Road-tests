...
class XroadSecurityServerCertImportGlobalConfExpired(unittest.TestCase):
    ...
    def test_securityServerGlobalConfExpired(self):
        ...
        expire_global_conf = client_certification_2_1_3.expire_global_conf(main, sshclient)
        ...
        start_xroad_conf_client = client_certification_2_1_3.start_xroad_conf_client(main, sshclient)
        try:
            expire_global_conf()
