...
class Cs_backup_restore_dlg_restore_confirm(CommonUtils):
    ...
    * 27.07.2017
    ...
    BUTTON_CANCEL = (By.XPATH, u'//div[7]/div[3]/div[1]/button[2]') # x: 1037 y: 514 width: 75 height: 36, tag: button, type: button, name: None, form_id: , checkbox: , table_id: backup_files, href:
