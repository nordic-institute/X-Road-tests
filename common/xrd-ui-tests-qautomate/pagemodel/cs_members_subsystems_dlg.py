...
class Cs_members_subsystems_dlg(CommonUtils):
    ...
    * 27.07.2017
    ...
    MENUBAR_CLOSE = (By.XPATH, u'//div[21]/div[1]/div[1]/button[2]') # x: 1409 y: 236 width: 51 height: 49, tag: button, type: submit, name: None, form_id: , checkbox: , table_id: DataTables_Table_2, href:
    ...
    MEMBER_DETAILS = (By.ID, u'ui-id-27') # x: 536 y: 302 width: 129 height: 29, tag: a, type: , name: None, form_id: , checkbox: , table_id: , href: https://test-cs2.i.palveluvayla.com:4000/#member_details_tab
    OWNED_SERVERS = (By.ID, u'ui-id-28') # x: 666 y: 302 width: 124 height: 29, tag: a, type: , name: None, form_id: , checkbox: , table_id: , href: https://test-cs2.i.palveluvayla.com:4000/#member_owned_servers_tab
    GLOBAL_GROUP_MEMBERSHIP = (By.ID, u'ui-id-29') # x: 791 y: 302 width: 202 height: 29, tag: a, type: , name: None, form_id: , checkbox: , table_id: , href: https://test-cs2.i.palveluvayla.com:4000/#member_group_membership_tab
    SUBSYSTEMS = (By.ID, u'ui-id-30') # x: 994 y: 302 width: 101 height: 29, tag: a, type: , name: None, form_id: , checkbox: , table_id: , href: https://test-cs2.i.palveluvayla.com:4000/#member_subsystems_tab
    MANAGEMENT_REQUESTS = (By.ID, u'ui-id-32') # x: 1207 y: 302 width: 177 height: 29, tag: a, type: , name: None, form_id: , checkbox: , table_id: , href: https://test-cs2.i.palveluvayla.com:4000/#member_management_requests_tab
